...
class LandsatProcessingTestCase(ActiniaResourceTestCaseBase):
    ...
    def test_landsat_computation_DOS4(self):
        rv = self.server.post('/landsat_process/LT41970251990147XXX03/DOS4/NDVI',
        ...
        rv = self.server.get('/download_cache', headers=self.admin_auth_header)
        pprint(json_load(rv.data))
        self.assertEqual(rv.status_code, 200, "HTML status code is wrong %i"%rv.status_code)
        self.assertEqual(rv.mimetype, "application/json", "Wrong mimetype %s"%rv.mimetype)
    ...
    def test_landsat_computation_TOAR(self):
        rv = self.server.post('/landsat_process/LT41970251990147XXX03/TOAR/NDVI',
                              headers=self.admin_auth_header)
        pprint(json_load(rv.data))
        self.assertEqual(rv.status_code, 200, "HTML status code is wrong %i"%rv.status_code)
        self.assertEqual(rv.mimetype, "application/json", "Wrong mimetype %s"%rv.mimetype)
    ...
    def test_landsat_computation_error_1(self):
        rv = self.server.post('/landsat_process/LT41970251990147XXX03/POS/NDVI',
                              headers=self.admin_auth_header)
        pprint(json_load(rv.data))
    ...
    def test_landsat_computation_error_2(self):
        rv = self.server.post('/landsat_process/LT41970251990147XXX03/TOAR/LOLO',
                              headers=self.admin_auth_header)
        pprint(json_load(rv.data))
        self.assertEqual(rv.status_code, 400, "HTML status code is wrong %i"%rv.status_code)
        self.assertEqual(rv.mimetype, "application/json", "Wrong mimetype %s"%rv.mimetype)
    ...
    def test_landsat_computation_error_3(self):
        rv = self.server.post('/landsat_process/LT41970241987299XXX0_NOPE/TOAR/NDVI',
                              headers=self.admin_auth_header)
        pprint(json_load(rv.data))
        self.assertEqual(rv.status_code, 200, "HTML status code is wrong %i"%rv.status_code)
        self.assertEqual(rv.mimetype, "application/json", "Wrong mimetype %s"%rv.mimetype)
