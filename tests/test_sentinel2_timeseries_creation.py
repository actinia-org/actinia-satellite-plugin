...
WRONG_PRODUCT_IDS = {"bands":["B04", "B08"],
                     "strds":["S2A_B04", "S2A_B08"],
                     "product_ids":["S2A_MSIL1C_20170212T104141_N0204_R008_T31TGJ_20170212T104138_NOPE",
...
WRONG_BANDS_IDS = {"bands":["B04_NOPE", "B08_NOPE"],
                     "strds":["S2A_B04", "S2A_B08"],
               "product_ids":["S2A_MSIL1C_20170212T104141_N0204_R008_T31TGJ_20170212T104138",
                              "S2A_MSIL1C_20170227T095021_N0204_R079_T34TBM_20170227T095613"]}

PRODUCT_IDS_ONE_WRONG = {"bands":["B04", "B08"],
               "strds":["S2A_B04", "S2A_B08"],
               "product_ids":["S2A_MSIL1C_20170212T104141_N0204_R008_T31TGJ_20170212T104138",
                              "S2A_MSIL1C_20170202T104241_N0204_R008_T32UNE_20170202T104236_NOPE"]}
...
class AsyncSentielTimeSeriesCreationTestCaseAdmin(ActiniaResourceTestCaseBase):
    ...
    def test_1(self):
        ...
        ############################################################################
        rv = self.server.post(URL_PREFIX + '/locations/LL/mapsets/A/sentinel2_import',
                              headers=self.admin_auth_header,
    ...
    def test_1_error_mapset_exists(self):
        ...
        """
        rv = self.server.post(URL_PREFIX + '/locations/LL/mapsets/PERMANENT/sentinel2_import',
                              headers=self.admin_auth_header,
                              data=json_dump(PRODUCT_IDS),
                              content_type="application/json")
